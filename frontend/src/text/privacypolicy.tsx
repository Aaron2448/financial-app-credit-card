export default function PrivacyPolicy() {
  return (
    <div>
      <p>At howzat.com, accessible from www.howzat.com, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by howzat.com and how we use
        it.</p>
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to
        the information that they shared and/or collect in howzat.com. This policy is not applicable to any information
      ...
      <p>howzat.com follows a standard procedure of using log files. These files log visitors when they visit websites.
        All
      ...
      <p>Like any other website, howzat.com uses "cookies". These cookies are used to store information including
        visitors'
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of howzat.com.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on howzat.com, which are sent directly to users' browser.
        They
      ...
      <p>Note that howzat.com has no access to or control over these cookies that are used by third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>howzat.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <p>howzat.com does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
